...
- DYNAMIC DAILY VOLUME & VARIETY: DO NOT just divide the retrieved exercises across the days, and DO NOT repeat the exact same exercises on different days. An intense day should have 5-8 exercises.
...
""")
    ...
    ANTI-LAZINESS RULE: You MUST generate a base cycle of AT LEAST 5 or 6 unique days. You are strictly forbidden from shrinking the cycle to 3 or 4 days to save effort. You MUST generate AT LEAST 20-30 physical exercises in the workout array across this cycle.
    ...
    You MUST populate the `day` field for every exercise (e.g., "Day 1 - Push (Cycle Day 1)")."""
        ...
        if "specialist_results" in result and "training" in result["specialist_results"]:
            ...
            if n_days > 1 and (workout_list or rest_list):
                e_workout, e_rest = self._expand_cycle(workout_list, rest_list, n_days, max_days=max_days)
